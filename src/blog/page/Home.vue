<script setup>
import {getBlogMenu} from "@/blog/api/blogApi.js";
...
<template>
    ...
    <div class="container px-4 py-6 mx-auto">
      <div class="lg:flex lg:items-center lg:justify-between">
        <div class="flex items-center justify-between">
          <div class="text-xl font-semibold text-gray-700" @click="getBlogMenu">
  ...
  <header class=" h-[28rem] bg-gray-50">
    <div class=" container mx-auto px-4 flex h-full py-6 items-center">
      <div class=" max-w-xl">
        ...
        <p class=" text-gray-500 mt-4 text-lg">Lorem ipsum dolor sit amet consectetur adipisicing elit. Soluta error
          odit vel minima optio consequuntur atque omnis, repellendus eos, rerum totam quas vitae voluptatibus, facere
          distinctio fugit? Nam, iure expedita!</p>
      </div>
    </div>
  </header>
  ...
  <section class=" container mx-auto px-4 py-10 lg:py-16">
    ...
    <div class="grid grid-cols-1 gap-8 md:grid-cols-2 mt-12 xl:grid-cols-3">
      ...
      <div>
        <img class="object-cover object-center w-full h-64 rounded-lg lg:h-80"
             src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRb1UizkegO75CK7joXI5YU_PyD-PrAKQj2reAOV99r4O5Ic3Y"
             alt="">
      ...
      <div>
        <img class="object-cover object-center w-full h-64 rounded-lg lg:h-80"
             src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQe9M4BrVwjAO9HM8h1tNhWJ0iOah_ERztSZKs8D2DrxSexPFs"
             alt="">
  ...
  <footer class="bg-white mt-12 dark:bg-gray-900">
    <div class="container px-4 py-12 mx-auto">
      <div class="md:flex md:-mx-3 md:items-center md:justify-between">
        <h1 class="text-3xl font-semibold tracking-tight text-gray-800 md:mx-3 xl:text-4xl dark:text-white">Subscribe
